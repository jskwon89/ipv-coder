...
export const allServices: ServiceItem[] = [
  ...
  { key: 'survey-exec', title: '설문조사 수행', description: '설문 배포, 데이터 수집 대행', href: '/survey-request', image: '/images/landing-설문조사.png', advanced: true },
  { key: 'judgment', title: '판결문 코딩', description: '판결문 수집부터 변수 코딩까지', href: '/judgment', image: '/images/landing-판결문.png', advanced: true },
  { key: 'news', title: '뉴스/언론 보도', description: '키워드 기반 뉴스 수집 및 분석', href: '/news-search', image: '/images/landing-기사검색.png', advanced: true },
  { key: 'quant', title: '고급 통계분석', description: 'SEM, 다수준, 패널분석 등 고급 분석', href: '/quant-analysis', image: '/images/landing-계량통계.png', advanced: true },
  ...
  { key: 'data-transform', title: '데이터 전처리', description: '리코딩, 결측치 처리, 병합 등', href: '/data-transform', image: '/images/landing-계량통계.png', advanced: true },
];
