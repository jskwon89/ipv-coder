      ...
      <div className="bg-[#1e2d47] rounded-xl border border-[#2a3a54] shadow-xl w-full max-w-md mx-4">
        ...
        <div className="border-t border-[#2a3a54] px-6 py-4 flex justify-end gap-3">
          ...
          <button
            ...
            className="px-5 py-2 bg-teal-500 text-[#0f1a2e] rounded-lg text-sm font-medium hover:bg-teal-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? "처리 중..." : "진행"}
          </button>
        </div>
