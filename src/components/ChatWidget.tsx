...
const autoReplies: { keywords: string[]; reply: string }[] = [
  ...
  {
    keywords: ["국제공모전", "해외공모전", "글로벌", "hult", "pitch", "영문 자료", "영문 응모"],
    reply: "국제/해외 공모전 참가에 필요한 영문 사업계획서, Pitch Deck, 한→영 번역, 네이티브 교정과 함께 주제 발굴·데이터 분석까지 한 흐름으로 지원합니다.\n\n'공모전/대회 > 국제공모전 상담신청' 메뉴에서 신청하실 수 있어요.",
  },
  {
    keywords: ["공모전", "대회", "사업계획", "창업", "응모", "제안서", "지원사업"],
    reply: "PRIMER는 공모전 참가에 필요한 주제 발굴, 자료 수집·통계분석, 응모 자료 작성(사업계획서·제안서·발표자료)까지 한 흐름으로 지원합니다.\n\n'공모전/대회' 메뉴에서 국내/국제 상담 신청을 하실 수 있어요.",
  },
  {
