...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed bottom-20 right-4 sm:right-6 w-[360px] max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden"
          style={{ height: "480px" }}
        >
          {/* Header */}
          ...
          {!user ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
              ...
              <p className="text-xs text-gray-500 mb-5">로그인하시면 상담사와 실시간 대화가 가능합니다.</p>
              <Link
