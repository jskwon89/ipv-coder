          ...
          <div className="max-w-7xl mx-auto">
            ...
            {!statsLoading && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                <Link href="/my" className="bg-white rounded-xl p-5 border-2 border-slate-300 shadow-sm hover:shadow-lg hover:border-slate-500 hover:-translate-y-0.5 transition-all group">
                  <div className="text-3xl sm:text-4xl font-bold text-gray-900">{totalStats.total}</div>
                  <div className="text-sm text-gray-600 mt-1 font-medium group-hover:text-gray-900">전체 의뢰</div>
                </Link>
                <Link href="/my?status=pending" className="bg-white rounded-xl p-5 border-2 border-amber-300 shadow-sm hover:shadow-lg hover:border-amber-500 hover:-translate-y-0.5 transition-all group">
                  <div className="text-3xl sm:text-4xl font-bold text-amber-600">{totalStats.pending}</div>
                  <div className="text-sm text-amber-700 mt-1 font-medium flex items-center gap-1.5 group-hover:text-amber-800"><span className="w-2 h-2 rounded-full bg-amber-500" />접수</div>
                </Link>
                <Link href="/my?status=in_progress" className="bg-white rounded-xl p-5 border-2 border-blue-300 shadow-sm hover:shadow-lg hover:border-blue-500 hover:-translate-y-0.5 transition-all group">
                  <div className="text-3xl sm:text-4xl font-bold text-blue-600">{totalStats.in_progress}</div>
                  <div className="text-sm text-blue-700 mt-1 font-medium flex items-center gap-1.5 group-hover:text-blue-800"><span className="w-2 h-2 rounded-full bg-blue-500" />진행중</div>
                </Link>
                <Link href="/my?status=completed" className="bg-white rounded-xl p-5 border-2 border-emerald-300 shadow-sm hover:shadow-lg hover:border-emerald-500 hover:-translate-y-0.5 transition-all group">
                  <div className="text-3xl sm:text-4xl font-bold text-emerald-600">{totalStats.completed}</div>
                  <div className="text-sm text-emerald-700 mt-1 font-medium flex items-center gap-1.5 group-hover:text-emerald-800"><span className="w-2 h-2 rounded-full bg-emerald-500" />완료</div>
                </Link>
              </div>
            )}
