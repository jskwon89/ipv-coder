    ...
    >
      ...
      <div className="p-3 sm:p-4 lg:p-6 max-w-full mx-2 sm:mx-4 lg:mx-6 relative z-10">
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-r from-[#0f1a2e] to-[#1a2744] p-5 sm:p-8 lg:p-10 mb-6 sm:mb-8 shadow-lg">
            ...
            <div className="flex items-start justify-between mb-5 sm:mb-8">
              <div>
                ...
                <button
                  ...
                  className="mt-4 sm:mt-5 inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-teal-500 text-white rounded-lg text-xs sm:text-sm font-semibold hover:bg-teal-400 transition-colors shadow-md"
                >
              ...
              <div className="flex items-center gap-2 shrink-0">
                {user ? (
                  ...
                  <Link
                    href="/login"
                    className="flex items-center gap-2 bg-teal-500 hover:bg-teal-400 rounded-lg px-4 py-2 transition-colors shadow-md"
                  >
          ...
          <div className="absolute -bottom-16 -left-8 w-48 h-48 rounded-full bg-teal-500/10" />
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
          <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-100 flex items-center justify-between">
            ...
            <button
              onClick={() => setShowModal(true)}
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-medium text-teal-500 border border-teal-500/30 rounded-lg hover:bg-teal-500/5 transition-colors"
            >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0 flex-1">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-teal-500/10 flex items-center justify-center shrink-0">
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 text-teal-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
                        </svg>
                      </div>
                      <div className="min-w-0">
                        <h3 className="text-sm sm:text-base font-semibold text-gray-900 group-hover:text-teal-500 transition-colors truncate">{project.name}</h3>
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 shrink-0 ml-2">
                      ...
                      <div className="w-16 sm:w-24 h-1.5 sm:h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-gradient-to-r from-[#14b8a6] to-[#2dd4bf] rounded-full transition-all"
                          style={{
                            width: `${project.caseCount > 0 ? (project.codedCount / project.caseCount) * 100 : 0}%`,
                          }}
                        />
                      </div>
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300 group-hover:text-teal-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4 border border-gray-200">
                  ...
                  <button
                    ...
                    className={`px-3 py-2.5 rounded-xl text-sm border-2 transition-all ${
                      selectedTemplate === "judgment"
                        ? "border-teal-500 bg-teal-500/10 text-teal-500 font-medium"
              ...
              <input
                ...
                autoFocus
                className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-400/30 focus:border-teal-500 transition-shadow placeholder-gray-300"
              />
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-teal-500 text-white rounded-xl text-sm font-medium hover:bg-teal-400 transition-colors disabled:opacity-50 shadow-sm"
                >
                  {creating ? "생성 중..." : "생성"}
                </button>
              </div>
...
function StatCard({
  ...
  const colorMap: Record<string, { text: string; iconBg: string }> = {
    ...
    amber: { text: "text-teal-400", iconBg: "bg-teal-500/20" },
