      ...
      <div className="mt-8 bg-card rounded-xl border border-border p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-indigo-900/30 text-indigo-400 flex items-center justify-center mx-auto mb-2 text-sm font-bold">1</div>
            <p className="text-sm font-medium">의뢰 접수</p>
            <p className="text-xs text-muted-foreground mt-1">설문 정보 입력 및 제출</p>
          </div>
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-indigo-900/30 text-indigo-400 flex items-center justify-center mx-auto mb-2 text-sm font-bold">2</div>
            <p className="text-sm font-medium">견적 안내</p>
            <p className="text-xs text-muted-foreground mt-1">검토 후 비용 및 일정 안내</p>
          </div>
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-indigo-900/30 text-indigo-400 flex items-center justify-center mx-auto mb-2 text-sm font-bold">3</div>
            <p className="text-sm font-medium">조사 진행</p>
            <p className="text-xs text-muted-foreground mt-1">설문 배포 및 응답 수집</p>
          </div>
          <div className="text-center">
            <div className="w-10 h-10 rounded-full bg-indigo-900/30 text-indigo-400 flex items-center justify-center mx-auto mb-2 text-sm font-bold">4</div>
