...
const highlightStyles: Record<string, { base: string; active: string; hover: string }> = {
  consultation: {
    base: "text-orange-600 lg:text-[1.05rem] font-bold",
    active: "text-orange-700 bg-orange-50",
    hover: "hover:text-orange-700 hover:bg-orange-50/70",
  },
  journal: {
    base: "text-indigo-600 lg:text-[1.05rem] font-bold",
      ...
      <button
        ...
        className={`flex items-center gap-1 px-3 py-2 rounded-lg transition-colors whitespace-nowrap ${
          hl
            ...
            : `text-[0.95rem] font-semibold ${isGroupActive ? "text-teal-600 bg-teal-50" : "text-gray-700 hover:text-gray-900 hover:bg-gray-50"}`
        }`}
      >
        {group.label}
        <svg
                  ...
                  <Link
                    ...
                    className={`px-3 py-2 rounded-lg transition-colors whitespace-nowrap ${
                      hl
                        ...
                        : `text-[0.95rem] font-semibold ${isActive ? "text-teal-600 bg-teal-50" : "text-gray-700 hover:text-gray-900 hover:bg-gray-50"}`
                    }`}
                  >
                    {group.label}
                  </Link>
