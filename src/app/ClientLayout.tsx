  ...
  return (
    <Link
      ...
      className={`flex items-center gap-2.5 pl-9 pr-3 py-2 rounded-lg text-[13px] transition-all duration-200 ${
        isActive
          ? "bg-teal-500/25 text-white font-semibold"
        ...
        <div className="md:hidden">
          {user ? (
            ...
            <Link
              href="/login"
              onClick={closeSidebar}
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-teal-500 hover:text-teal-500/80 hover:bg-white/10 transition-all w-full"
            >
          ...
          <div className="space-y-1">
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2 rounded-lg text-xs transition-all ${
                pathname === "/admin" ? "bg-teal-500/25 text-white font-semibold" : "text-[#e0e7ef] hover:bg-white/10 hover:text-white"
              }`}
            >
