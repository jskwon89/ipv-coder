  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-medium bg-cyan-500/20 text-cyan-400 px-2 py-0.5 rounded-full">
              준비 중
            </span>
          </div>
      ...
      <div className="space-y-3 mb-6">
        <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg px-4 py-3 flex items-start gap-3">
      ...
      <div className="bg-card rounded-xl border border-border mt-6">
        <div className="px-6 py-4 border-b border-border flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              disabled
              className="px-3 py-1.5 border border-border rounded-lg text-xs font-medium hover:bg-secondary/50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Excel
            </button>
            <button
