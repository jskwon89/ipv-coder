      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-medium bg-purple-500/20 text-purple-400 px-2 py-0.5 rounded-full">
              준비 중
            </span>
          </div>
        ...
        <div className="flex flex-wrap gap-2 mt-3">
          {PRESET_QUESTIONS.map((q) => (
            <button
              ...
              className="px-3 py-1.5 text-xs font-medium border border-purple-500/30 text-purple-400 rounded-full hover:bg-purple-500/10 transition-colors"
            >
              {q}
            </button>
          ))}
