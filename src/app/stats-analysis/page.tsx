          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-md">
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <button
                ...
                className="w-full px-4 py-2.5 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#c49a2e]/20 focus:border-[#c49a2e] resize-none"
                />
              </div>
