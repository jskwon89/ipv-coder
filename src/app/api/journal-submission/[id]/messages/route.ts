...
import { getJournalSubmissionMessages, addJournalSubmissionMessage } from '@/lib/db';
...
export async function GET(
  ...
  try {
    ...
    const messages = await getJournalSubmissionMessages(id);
    messages.sort(
...
export async function POST(
  ...
  try {
    ...
    const msg = await addJournalSubmissionMessage(id, sender, message.trim());
