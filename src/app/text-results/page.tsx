      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        {sorted.length === 0 ? (
          <div className="px-6 py-16 text-center">
            ...
            <Link href="/text-analysis" className="inline-flex items-center gap-2 px-4 py-2 bg-teal-500 text-white rounded-lg text-sm font-medium hover:bg-teal-600 transition-colors">
              텍스트 분석 의뢰하기
            </Link>
          </div>
        ) : (
