      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
        ...
        {searchType === "keyword" ? (
          <div>
            <div className="flex gap-2 mb-3">
              <input
                ...
                className="flex-1 px-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-400/40 focus:border-teal-500"
              />
              <button
                onClick={addKeyword}
                className="px-4 py-2.5 bg-teal-500 text-white rounded-lg text-sm font-medium hover:bg-teal-600 transition-colors"
              >
                추가
              </button>
            </div>
              ...
              <div className="flex flex-wrap items-center gap-2 mb-3">
                {keywords.map((kw, i) => (
                  <span key={kw} className="flex items-center">
                    ...
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-amber-50 text-teal-500 rounded-full text-sm border border-teal-500/20">
                      {kw}
                      <button
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-400/40 focus:border-teal-500 mb-3"
          />
        )}
        ...
        <div className="flex flex-wrap items-end gap-4 mt-4 pt-4 border-t border-gray-100">
          <div>
            ...
            <input
              ...
              className="px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-400/40 focus:border-teal-500"
            />
          </div>
          <div>
            <label className="block text-xs text-gray-500 mb-1">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mb-6">
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-400/40 focus:border-teal-500 md:max-w-sm"
          />
        </div>
      </div>
