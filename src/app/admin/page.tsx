            ...
            <div className="flex gap-3 items-end">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-400/30 focus:border-teal-500"
                />
              </div>
              <div className="flex gap-2">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-teal-500 text-white rounded-xl text-sm font-semibold hover:bg-teal-400 disabled:opacity-50 transition-colors"
              >
                {charging ? "충전 중..." : "충전"}
              </button>
            </div>
