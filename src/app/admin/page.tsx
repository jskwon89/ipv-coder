...
const serviceTypes = [
  ...
  { key: "contest", label: "공모전 상담 (국내/국제)", api: "/api/contest", titleField: "contestField" },
];
                ...
                {flatRequests
                  ...
                  .map((req) => (
                    <div key={req.id} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-0">
                      <div>
                        <span className="text-xs font-medium text-primary mr-2">[{req._label}]</span>
                      ...
                      <button
                        ...
                        className="px-3 py-1 text-xs text-primary border border-teal-600/30 rounded-lg hover:bg-primary/5"
                      >
                        처리
                      </button>
                    </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3 items-center">
            <select
              ...
              className="px-3 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-600/30"
            >
                        ...
                        <tr key={`${req._type}-${req.id}`} className="border-b border-gray-50 hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-right">
                            <button
                              ...
                              className="px-3 py-1.5 text-xs text-primary border border-teal-600/30 rounded-lg hover:bg-primary/5 transition-colors"
                            >
                              상세/처리
                            </button>
                          </td>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-600/30"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-600/30 resize-none"
                      />
                    </div>
                    <button
                  ...
                  <div className="border-t border-gray-100 pt-4">
                      ...
                      {chatMessages.length === 0 ? (
                        ...
                        chatMessages.map((msg) => (
                          <div key={msg.id} className={`flex ${msg.sender === "admin" ? "justify-end" : "justify-start"}`}>
                            <div className={`max-w-[80%] rounded-lg px-3 py-2 text-sm ${msg.sender === "admin" ? "bg-primary/10 text-gray-900" : "bg-gray-100 text-gray-900"}`}>
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-600/30"
                      />
                      <button
                ...
                <div key={section.key} className="flex items-center justify-between p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                  ...
                  <button
                    ...
                    className={`relative w-12 h-6 rounded-full transition-colors ${
                      siteSettings[section.key] ? "bg-primary" : "bg-gray-300"
                    }`}
                  >
                    <span
