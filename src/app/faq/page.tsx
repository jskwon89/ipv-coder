...
const faqs: FaqItem[] = [
  {
    category: "서비스 일반",
    q: "PRIMER은 어떤 서비스인가요?",
    a: "PRIMER은 연구자를 위한 통합 연구 지원 플랫폼입니다. 연구 설계, 설문조사, 판결문 코딩, 뉴스 수집, 통계분석, 텍스트 분석, 질적분석 등 연구에 필요한 다양한 서비스를 제공합니다.",
  },
  {
    category: "서비스 일반",
  ...
  },
  {
    category: "견적/결제",
    q: "결제는 어떻게 진행되나요?",
    a: "의뢰 내용을 먼저 검토한 뒤 작업 범위에 맞는 견적을 안내드립니다. 결제는 우선 무통장입금 방식으로 진행하며, 입금 확인 후 작업을 시작합니다.",
  },
  {
    category: "견적/결제",
    q: "견적은 언제 받을 수 있나요?",
    a: "의뢰 양식에 연구 주제, 데이터 형태, 원하는 분석 범위를 남겨주시면 담당자가 확인 후 안내드립니다. 작업량이 달라질 수 있어 고정 금액보다 의뢰별 견적을 기준으로 운영합니다.",
  },
  {
    category: "연구 설계",
  ...
  {
    category: "데이터 분석",
    q: "통계분석은 어떤 분석을 포함하나요?",
    a: "기초통계(기술통계, 빈도분석), 회귀분석(OLS, 로지스틱, 패널), 인과추론(DID, RDD, IV), 구조방정식(SEM), 시계열분석 등 다양한 통계 분석 방법을 지원합니다.",
  },
  {
    category: "데이터 분석",
