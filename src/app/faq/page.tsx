...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "연구 주제 및 방향 설계, 연구 질문 구체화, 연구 방법론 제안, 변수 설정 등을 지원합니다. AI 기반으로 관련 선행 연구와 트렌드를 분석하여 최적의 연구 설계를 도와드립니다.",
  },
  {
    category: "연구 설계",
    q: "통계분석 설계란 무엇인가요?",
  ...
  },
  {
    category: "데이터 수집",
    q: "판결문 수집은 어떻게 진행되나요?",
    a: "원하는 조건(법원, 사건 유형, 기간 등)에 맞는 판결문을 수집하고, AI 기반 코딩 시스템으로 주요 정보를 자동 추출합니다. 코딩 결과는 프로젝트 페이지에서 확인하고 수정할 수 있습니다.",
  },
  {
    category: "데이터 수집",
