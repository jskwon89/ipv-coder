    ...
    <div className="p-8 max-w-5xl mx-auto">
      <PageHeader
        ...
        action={
          <button
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1e3a5f] text-white rounded-xl text-sm font-medium hover:bg-[#162d4a] transition-colors shadow-sm"
          >
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-16 text-center">
            ...
            <button
              onClick={() => setShowModal(true)}
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1e3a5f] text-white rounded-xl text-sm font-medium hover:bg-[#162d4a] transition-colors"
            >
              첫 프로젝트 만들기
            </button>
          </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-2xl p-8 w-full max-w-md mx-4">
            ...
            <input
              ...
              autoFocus
              className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#1e3a5f]/30 focus:border-[#1e3a5f]"
            />
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-[#1e3a5f] text-white rounded-xl text-sm font-medium hover:bg-[#162d4a] transition-colors disabled:opacity-50"
              >
                {creating ? "생성 중..." : "생성"}
              </button>
            </div>
