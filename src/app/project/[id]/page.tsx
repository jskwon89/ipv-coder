      ...
      {uploadedFiles.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          <textarea
            ...
            className="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-400/40 focus:border-teal-500 resize-none mb-4"
          />
          {requested ? (
            ...
            <button
              ...
              disabled={requesting}
              className="w-full px-6 py-3 bg-teal-500 text-white rounded-lg text-sm font-semibold hover:bg-teal-600 transition-colors disabled:opacity-50"
            >
